...
class App:
    ...
    def draw_battle(self):
        ...
        pyxel.rect(10, 10, 236, 60, 1)  # 敵ウィンドウ
        pyxel.rectb(10, 10, 236, 60, 7)
        pyxel.text(100, 30, "Enemy", 8)

        pyxel.rect(10, 80, 120, 40, 1)  # プレイヤーステータス
        pyxel.rectb(10, 80, 120, 40, 7)
        pyxel.text(20, 90, f"HP: {self.player_hp}", 7)

        pyxel.rect(10, 130, 236, 40, 1)  # ログウィンドウ
        pyxel.rectb(10, 130, 236, 40, 7)
        pyxel.text(20, 140, self.battle_log, 7)

        pyxel.rect(140, 80, 106, 40, 1)  # コマンドウィンドウ
        pyxel.rectb(140, 80, 106, 40, 7)
        commands = ["戦う", "逃げる"]
        for i, cmd in enumerate(commands):
            color = 7 if i == self.battle_command else 5
            pyxel.text(150, 90 + i * 10, ("> " if i == self.battle_command else "  ") + cmd, color)
