...
class App:
    ...
    def update(self):
        if self.chest_opened and pyxel.btnp(pyxel.KEY_RETURN):
            self.chest_log = ""
            self.chest_opened = False
        if self.chest_state:
            self.update_chest()
    ...
    def draw_dungeon(self):
        ...
        if self.chest_opened:
            pyxel.rect(20, 100, 200, 40, 1)
            pyxel.rectb(20, 100, 200, 40, 7)
            pyxel.text(30, 120, self.chest_log, 7)
